...
/**
*
* This is the Driver for the Breadth First Search class.
* An adjacency List is created using a INPUT file utilizing
* a MATRIX text file. The matrix text file is parsed for irregularities
* and verifies matrix for Breadth First Search ligitamacy to be converted 
* into an Adjacency List. Once the Matrix file is verfied, it is then 
* converted into an Adcaency List, and prepped for the BFS (Bread First Search)
* algorithm. 
*
* The algorithm them lets the user pick a starting point for
* the Breath First Search to begin the search. User must choose
* a data point to allow the Breadth First Search to run.
*
*@author Byron Teran
*@ver 5.0
*
